...
/**
 * Reducer returning the editing nhom8 device type.
 *
 * @param {Object} state  Current state.
 * @param {Object} action Dispatched action.
 *
...
/**
 * Returns an action object used to toggle the width of the editing nhom8.
 *
...
/**
 * Returns the current editing nhom8 device type.
 *
 * @param {Object} state Global application state.
 *
...
function VisualEditor() {
  ...
  var inlineStyles = Object(external_this_wp_blockEditor_["__experimentalUseResizenhom8"])(deviceType);
...
var images_nhom8Image = function nhom8Image(props) {
...
function WelcomeGuide() {
  ...
  return Object(external_this_wp_element_["createElement"])(external_this_wp_components_["Guide"], {
    ...
    pages: [{
      image: Object(external_this_wp_element_["createElement"])(images_nhom8Image, null),
