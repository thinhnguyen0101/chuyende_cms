...
<!-- 
    ...
    <link rel="stylesheet" href="./public/js/bootstrap.min.js">
    <link rel="stylesheet" href="./public/js/canvas.js"> -->
    ...
    <!-- <link
media=all href=https://blog.365canvas.com/wp-content/cache/autoptimize/css/autoptimize_983fd5d1184e30805354742aeb19d076.css rel=stylesheet>-->
    <?php wp_head(); ?> 
</head>
<body>
    <style>
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <div class="container">
            <a class="navbar-brand" href="#"><img src = "<?php echo $image [0];?> " alt = "" width="300" height="150"></a>
            <div class="item-menu">
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto resize">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/cms/nhom8/product">Shop</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="contact">Contact Us</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link login" href="#">LOGIN / RESGITER <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
