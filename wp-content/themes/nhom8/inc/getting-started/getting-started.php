...
function vw_ecommerce_shop_admin_theme_style() {
   ...
   wp_enqueue_style('vw-ecommerce-shop-custom-admin-style', get_template_directory_uri() . '/inc/getting-started/getting-started.css');
   wp_enqueue_script('vw-ecommerce-shop-tabs', get_template_directory_uri() . '/inc/getting-started/js/tab.js');
}
